...
trait DatasetMultiRegionDoobieInstances {

  implicit def DatasetMultiRegionMeta: Meta[DatasetMultiRegion] =
    Meta[String].tiemap(DatasetMultiRegion.fromString)(_.value)

}

object DatasetMultiRegionDoobieInstances extends DatasetMultiRegionDoobieInstances {
